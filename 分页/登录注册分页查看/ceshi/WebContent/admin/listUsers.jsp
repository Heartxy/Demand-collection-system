...
<script src="${pageContext.request.contextPath}/static/bootstrap-3.3.5-dist/js/bootstrap.js"
...
<td>${item.salt }</td>
<td><a
		href="${pageContext.request.contextPath}/admin/adminServlet?method=toUpdate&updateId=${item.id }">修改
</a></td>
<td><a
		href="${pageContext.request.contextPath}/admin/adminServlet?method=delete&updateId=${item.id }"
		onClick="return confirm('确定要删除这条记录么？')"
		>删除
</a></td>
</tr>
</c:forEach>
